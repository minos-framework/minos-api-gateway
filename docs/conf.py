#!/usr/bin/env python
#
# api_gateway documentation build configuration file, created by
...
from minos.api_gateway import rest
...
htmlhelp_basename = 'minosapi_gatewaydoc'
...
latex_documents = [
    (master_doc, 'minos.tex',
     'Minos Api Gateway Documentation',
